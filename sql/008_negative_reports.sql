...
CREATE TABLE IF NOT EXISTS negative_reports (
    ...
    vehicle_plate        TEXT,
    -- Position at the time of reporting. Required.
    report_lat           DOUBLE PRECISION NOT NULL,
    report_lon           DOUBLE PRECISION NOT NULL,
    -- H3 cells: caller-supplied if present, otherwise computed server-side
    -- from report_lat/report_lon and recorded here.
