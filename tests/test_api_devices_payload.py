...
_ROW = (
    ...
    None, None, None, None,
    # 30-35 crowdsourced features (sql/055, sql/058). Read UNCONDITIONALLY
    # by the payload builder, so a fixture that stops short of them is a
    # fixture the handler cannot run against.
